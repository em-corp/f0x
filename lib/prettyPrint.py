...
class Prettify:
    ...
    def magenta(text):
        return f.MAGENTA + Prettify.__cont__(text, f.RESET, f.MAGENTA) + \
                f.RESET
    ...
    def on_magenta(text):
        return b.MAGENTA + Prettify.__cont__(text, b.RESET, b.MAGENTA) + \
                b.RESET
    ...
    def as_bold(text):
        return s.BRIGHT + Prettify.__cont__(text, s.RESET_ALL, s.BRIGHT) + \
                s.RESET_ALL

    def as_dim(text):
        return s.DIM + Prettify.__cont__(text, s.RESET_ALL, s.BRIGHT) + \
                s.RESET_ALL
